...
('admin', '$2a$10$N9qo8uLOickgx2ZMRZoMye.IjzqAKL9xL5jvMFVdNJHvGCgTq/VEq', '13800138000', '管理员', 'ADMIN', 1, 1, '罗卜田乡', '是', '正式党员', '2010-07-01', '第一党支部', 95, '村党支部书记', '党建,乡村振兴', '2018-03-10', '第一网格', '430101198005121234', '罗卜田乡1组', '张四', '139001394567', NOW()),
('village_official', '$2a$10$N9qo8uLOickgx2ZMRZoMye.IjzqAKL9xL5jvMFVdNJHvGCgTq/VEq', '13900139000', '村干部', 'VILLAGE_OFFICIAL', 1, 1, '罗卜田乡', '是', '正式党员', '2015-07-01', '第一党支部', 86, '网格员', '综治调解,便民服务', '2020-05-15', '第三网格', '430101198508205678', '罗卜田乡2组', '李五', '138001385678', NOW()),
('resident_official', '$2a$10$N9qo8uLOickgx2ZMRZoMye.IjzqAKL9xL5jvMFVdNJHvGCgTq/VEq', '13700137000', '驻村干部', 'RESIDENT_OFFICIAL', 1, 1, '罗卜田乡', '是', '正式党员', '2008-07-01', '派出单位党支部', 92, '驻村工作队队员', '乡村振兴,党建', '2023-01-01', '全村', '430101197812109012', '村委会宿舍', '王六', '136001361234', NOW()),
('villager', '$2a$10$N9qo8uLOickgx2ZMRZoMye.IjzqAKL9xL5jvMFVdNJHvGCgTq/VEq', '13600136000', '村民', 'VILLAGER', 1, 1, '罗卜田乡', '否', NULL, NULL, NULL, 0, '普通村民', NULL, NULL, NULL, '430101199003153456', '罗卜田乡3组', '赵七', '135001357890', NOW());
...
('罗卜田乡', 2580, 12.5, 680, '12个村民组', '浙江省杭州市余杭区', '罗卜田乡历史悠久，始建于明朝，距今已有600多年历史。村内保留了众多明清古建筑，是省级历史文化名村。', '省级文明村、省级生态村、市级美丽乡村示范村', '龙井茶、竹笋、杨梅、草莓', 2850000, NOW());
...
('张三', '男', '1980-05-12', '2005-07-01', '13800138001', '罗卜田乡1组', '正式', '在册', 95, NOW()),
('李四', '女', '1985-08-20', '2010-07-01', '13800138002', '罗卜田乡2组', '预备', '在册', 80, NOW()),
('王五', '男', '1990-03-15', '2022-07-01', '13800138003', '罗卜田乡3组', '积极分子', '在册', 60, NOW());
...
('2024年美丽乡村建设申报书', '本村上报', 'SC2024001', '罗卜田乡', '申报2024年美丽乡村建设项目，涉及环境整治、基础设施提升', '', '2024-05-15 00:00:00', '待办', NOW()),
...
('2023年度村务工作总结', '年度总结', '罗卜田乡2023年度村务工作总结报告', '', NOW()),
('2023年财务决算资料', '财务档案', '罗卜田乡2023年度财务决算相关资料', '', NOW());
...
('小明', '留守儿童', '13800138201', '罗卜田乡1组', '2024年3月走访：生活学习正常', '2024-03-10 00:00:00', NOW()),
('李奶奶', '独居老人', '13800138202', '罗卜田乡2组', '2024年3月走访：身体状况良好', '2024-03-12 00:00:00', NOW()),
('王师傅', '残疾人', '13800138203', '罗卜田乡3组', '2024年2月走访：建议申请残疾人补贴', '2024-02-20 00:00:00', NOW());
...
('张大爷家', '罗卜田乡1组', '水冲式', '', '', '已验收', 1500, NOW()),
('李大妈家', '罗卜田乡2组', '三格式', '', '', '已验收', 1200, NOW()),
('王师傅家', '罗卜田乡3组', '水冲式', '', '', '待验收', 0, NOW());
...
('张大爷户', '430101195001011234', '男', 75, '13800138001', '罗卜田乡1组', '张大爷、张大妈、张小三', 1, '', '第一组', NOW()),
('李叔叔户', '430101197501015678', '男', 50, '13800138002', '罗卜田乡2组', '李叔叔、李婶、李小四', 0, '浙江杭州', '第二组', NOW());
...
('张大爷宅基', '宅基地', '罗卜田乡1组', 120, '2005-06-01', '张大爷', '430101195001011234', 'NORMAL', NOW()),
('李叔叔承包地', '承包地', '罗卜田乡南', 5.5, NULL, '李叔叔', '430101197501015678', 'NORMAL', NOW());
...
('王小明', '男', '13800139001', '罗卜田乡1组', '环境整治,政策宣传', '2024-01-15', 36, 180, 1, NOW()),
('李美丽', '女', '13800139002', '罗卜田乡2组', '关爱老人,便民服务', '2024-02-20', 28, 140, 1, NOW());
...
('关爱独居老人活动', '关爱老人', '走访独居老人送温暖', '罗卜田乡2组', '2024-04-10', '李美丽,王五', 8, NOW());
...
('罗卜田乡开展春季环境整治活动', '工作动态', '近日，罗卜田乡组织全村党员干部开展春季环境卫生大整治活动', '村委宣传员', NOW(), 1, NOW()),
('罗卜田乡茶叶产业助力乡村振兴', '产业宣传', '罗卜田乡依托茶叶合作社带动村民增收致富', '村委宣传员', NOW(), 1, NOW());

INSERT INTO media_submission (title, target_media, content, submit_date, publish_status, create_time) VALUES
('罗卜田乡美丽乡村建设纪实', '乡镇融媒体', '罗卜田乡推进美丽乡村建设经验做法', NOW(), 'PUBLISHED', NOW()),
('罗卜田乡党建引领基层治理', '县级媒体', '党建工作经验材料', NOW(), 'PENDING', NOW());
...
('赵困难', '430101196501013456', '13800138006', '低保', '赵困难、妻、子', '罗卜田乡3组', 600, 1, NOW()),
('钱残疾', '430101197001017890', '13800138007', '残疾人', '钱残疾', '罗卜田乡1组', 300, 1, NOW());
