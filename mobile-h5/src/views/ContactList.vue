...
const villages = ref([
  {
    name: '冬瓜坡村',
    members: [
      { position: '党支部书记、村委会主任', name: '李夏艳', phone: '18374555056', remark: '' },
  ...
  },
  {
    ...
    members: [
      ...
      { position: '党支部组织、宣传委员、村妇联主席', name: '艾艾红', phone: '17769245689', remark: '' },
