...
const workDetails = ref([
  ...
  },
  {
    ...
    workItems: [
      ...
      { icon: '👥', text: '志愿者管理：志愿者花名册动态更新与维护，志愿者服务时长统计与月度更新，志愿者常态化培训与主题活动组织' },
      { icon: '📋', text: '活动策划执行：年度/月度新时代文明实践活动方案制定，活动落地执行与全流程记录，活动宣传素材整理与资料归档' },
      { icon: '🏛️', text: '阵地建设管理：新时代文明实践站所日常运维与环境管理，阵地设施设备盘点与维护，阵地开放使用登记与预约管理' },
      { icon: '🤝', text: '志愿服务队伍建设：志愿服务队伍招募、注册与备案，队伍分类管理与服务能力提升，志愿服务项目孵化与落地运营' }
    ],
    documents: [
      { icon: '🌟', title: '文明实践计划表', description: '新时代文明实践所、站计划安排及活动方案' },
      { icon: '👥', title: '志愿者管理资料', description: '志愿者花名册、服务时长台账、培训与活动记录台账' },
      { icon: '📋', title: '活动策划执行资料', description: '活动方案审批表、活动执行记录表、宣传稿件与现场影像资料归档' },
      { icon: '🏛️', title: '阵地建设管理资料', description: '阵地设施设备台账、阵地开放使用登记表、阵地运维检查记录' },
      { icon: '🤝', title: '志愿服务队伍资料', description: '志愿服务队伍人员名单、志愿服务项目台账、队伍培训与能力提升记录' }
    ]
  },
  {
    leaderId: 4,
